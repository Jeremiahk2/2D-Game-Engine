...
namespace v8helpers
{
	...
	v8::Local<v8::Object> exposeToV8(std::string object_name, R *object_ref, std::vector<ParamContainer<G, S>> list_of_params, v8::Isolate *isolate, v8::Local<v8::Context> &context, std::string context_name="default")
	{
		...
		{
			object_template->SetAccessor(v8::String::NewFromUtf8(isolate, p.name_.c_str()).ToLocalChecked(), p.getter_, p.setter_);
		}
		...
		context->Global()->Set(context, v8::String::NewFromUtf8(isolate, object_name.c_str()).ToLocalChecked(), object);
